...
function stateColor(state: number): string {
  switch (state) {
    ...
    case 1: return 'text-warning border-warning/30';
    case 2: return 'text-yes border-yes/30';
                          ...
                          <div className="flex items-center justify-between gap-2 text-xs">
                            <div className="flex items-center gap-3">
                              <span className="text-muted-foreground">
                                ...
                                <span className="text-yes ml-1">(${(bet.stakeEth * ethUsd).toFixed(2)})</span>
                              </span>
                            </div>
                    ...
                    <>
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <Card className="p-4 text-center">
                          ...
                          <p className="text-2xl font-bold">
                            <span className="text-yes">{winCount}</span>
                            <span className="text-muted-foreground mx-1">-</span>
                            <span className="text-no">{lossCount}</span>
                            <span className="text-muted-foreground mx-1">-</span>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <Card className="p-3 text-center">
                          ...
                          <p className="text-[10px] text-yes">${(totalWagered * ethUsd).toFixed(2)}</p>
                        </Card>
                        <Card className="p-3 text-center">
                          <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-1">Won</p>
                          <p className="text-sm font-bold font-mono text-yes">{totalWon.toFixed(4)}</p>
                          <p className="text-[10px] text-muted-foreground">ETH</p>
                          <p className="text-[10px] text-yes">${(totalWon * ethUsd).toFixed(2)}</p>
                        </Card>
                        <Card className="p-3 text-center">
                          <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-1">Net P/L</p>
                          <p className={`text-sm font-bold font-mono ${netPL >= 0 ? 'text-yes' : 'text-no'}`} data-testid="text-net-pl">
                            {netPL >= 0 ? '+' : ''}{netPL.toFixed(4)}
                          </p>
                          <p className="text-[10px] text-muted-foreground">ETH</p>
                          <p className={`text-[10px] ${netPL >= 0 ? 'text-yes' : 'text-no'}`}>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <Card className="p-3">
                          ...
                          {biggestWin > 0 && (
                            <p className="text-[10px] text-yes">${(biggestWin * ethUsd).toFixed(2)}</p>
                          )}
                        </Card>
                        <Card className="p-3">
                          <div className="flex items-center gap-2 mb-1">
                          ...
                          <p className={`text-sm font-bold ${streakType === 'W' ? 'text-yes' : streakType === 'L' ? 'text-no' : 'text-muted-foreground'}`}>
