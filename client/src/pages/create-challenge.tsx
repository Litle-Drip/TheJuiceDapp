    ...
    <div className="space-y-4 max-w-xl mx-auto" data-testid="create-challenge-page">
      ...
      <Card className="p-5">
        ...
        {preview && (
          <div className="rounded-md border border-border bg-muted/30 p-4 mb-5" data-testid="challenge-preview">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-[#6b8f71]">Winner takes</span>
                <div className="text-right">
                  <span className="text-sm font-mono font-bold text-[#6b8f71]" data-testid="text-preview-payout">
                    +{preview.profit.toFixed(6)} ETH
                  </span>
                  <span className="text-xs text-[#6b8f71]/70 ml-1">(${preview.profitUsd.toFixed(2)})</span>
        ...
        {(lastChallengeId || lastTxHash) && (
          <div className="mt-3 p-3 rounded-md border border-[#6b8f71]/30 bg-[#6b8f71]/5 space-y-3" data-testid="challenge-created-success">
            {lastChallengeId && (
              <div className="space-y-2">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <div>
                    <p className="text-xs text-[#6b8f71] font-medium">Your challenge is live!</p>
